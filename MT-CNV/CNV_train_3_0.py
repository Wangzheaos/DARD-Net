...
def parameters():
    ...
    a = []
    with open('./results/CNV_train_3_0/record_CNV_train_3_0.txt') as f:
    ...
    for data_seed in range(10):
        r = './results/CNV_train_3_0/' + str(a[data_seed]) + '/3150_' + str(data_seed) + '/transient/best.ckpt'
        # if not os.path.isfile(r+'.f'):
        #     r = './results/CNV_train_3_0/' + str(a[data_seed]) + '/3150_' + str(data_seed) + '/transient/checkpoint.185.ckpt'
