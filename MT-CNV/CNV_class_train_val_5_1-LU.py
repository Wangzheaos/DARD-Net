...
def parameters():
    ...
    a = []
    with open('./results/CNV_class_train_val_5_1-LU/record_CNV_class_train_val_5_1-LU.txt') as f:
    ...
    for data_seed in range(0, 5):
        r = './results/CNV_class_train_val_5_1-LU/' + str(a[data_seed]) + '/384_' + str(data_seed) + '/transient/best.ckpt'
