...
def parameters():
    ...
    a = []
    with open('./results/CNV_center_5_5-3-50/record_CNV_center_5_5-3-50.txt') as f:
    ...
    for data_seed in range(0, 10):
        r = './results/CNV_center_5_5-3-50/' + str(a[data_seed]) + '/6300_' + str(data_seed) + '/transient/best.ckpt'
        # if not os.path.isfile(r+'.f'):
        #     r = './results/CNV_center_5_5-3-50/' + str(a[data_seed]) + '/6300_' + str(data_seed) + '/transient/checkpoint.185.ckpt'
