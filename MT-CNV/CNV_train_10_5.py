...
def parameters():
    ...
    a = []
    best_num = []
    with open('./results/CNV_train_10_5/record_CNV_train_10_5.txt') as f:
    ...
    for data_seed in range(0, 10):
        r = './results/CNV_train_10_5/' + str(a[data_seed]) + '/3150_' + str(data_seed) + '/transient/best.ckpt'
        if not os.path.isfile(r+'.f'):
            r = './results/CNV_train_10_5/' + str(a[data_seed]) + '/3150_' + str(data_seed) + '/transient/checkpoint.' + best_num[data_seed] + '.ckpt'
