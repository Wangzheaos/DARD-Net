...
def parameters():
    ...
    a = []
    with open('./results/CNV_class_train_val_5_1-75/record_CNV_class_train_val_5_1-75.txt') as f:
    ...
    for data_seed in range(0, 10):
        r = './results/CNV_class_train_val_5_1-75/' + str(a[data_seed]) + '/9450_' + str(data_seed) + '/transient/best.ckpt'
        # if not os.path.isfile(r+'.f'):
        #     r = './results/CNV_class_train_val_5_1-75/' + str(a[data_seed]) + '/9450_' + str(data_seed) + '/transient/checkpoint.185.ckpt'

        yield {
            **defaults,
            'title': '9450-label cnv',
            'n_labels': 9450,
            'data_seed': data_seed,
            'epochs': 200,
