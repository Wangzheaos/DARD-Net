...
def parameters():
    ...
    a = []
    with open('./results/CNV_train_20_5/record_CNV_train_20_5.txt') as f:
    ...
    for data_seed in range(0, 10):
        r = './results/CNV_train_20_5/' + str(a[data_seed]) + '/3150_' + str(data_seed) + '/transient/best.ckpt'
