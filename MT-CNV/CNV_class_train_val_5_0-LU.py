...
def parameters():
    ...
    a = []
    with open('./results/CNV_class_train_val_5_0-LU/record_CNV_class_train_val_5_0-LU.txt') as f:
    ...
    for data_seed in range(0, 5):
        r = './results/CNV_class_train_val_5_0-LU/' + str(a[data_seed]) + '/384_' + str(data_seed) + '/transient/best.ckpt'
        # if not os.path.isfile(r+'.f'):
        #     r = './results/CNV_class_train_val_5_0/' + str(a[data_seed]) + '/3150_' + str(data_seed) + '/transient/checkpoint.185.ckpt'
