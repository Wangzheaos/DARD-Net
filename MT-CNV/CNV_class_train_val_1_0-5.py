...
def parameters():
    defaults = {
        ...
        # Costs
        'consistency_weight_1': 1,
        'consistency_weight_2': 0.5,
    ...
    a = []
    with open('./results/CNV_class_train_val_1_0-5/record_CNV_class_train_val_1_0-5.txt') as f:
    ...
    for data_seed in range(0, 10):
        r = './results/CNV_class_train_val_1_0-5/' + str(a[data_seed]) + '/3150_' + str(data_seed) + '/transient/best.ckpt'
        # if not os.path.isfile(r+'.f'):
        #     r = './results/CNV_class_train_val_1_0-5/' + str(a[data_seed]) + '/3150_' + str(data_seed) + '/transient/checkpoint.185.ckpt'
