...
def parameters():
    defaults = {
        ...
        # Costs
        'consistency_weight_1': 8,
        'consistency_weight_2': 4,
    ...
    a = []
    with open('./results/CNV_class_train_val_8_4/record_CNV_class_train_val_8_4.txt') as f:
    ...
    # 3150(25%) labels:
    for data_seed in range(3, 10):
        r = './results/CNV_class_train_val_8_4/' + str(a[data_seed]) + '/3150_' + str(data_seed) + '/transient/best.ckpt'
        # if not os.path.isfile(r+'.f'):
        #     r = './results/CNV_class_train_val_8_4/' + str(a[data_seed]) + '/3150_' + str(data_seed) + '/transient/checkpoint.185.ckpt'
