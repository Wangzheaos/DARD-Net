...
def parameters():
    ...
    a = []
    with open('./results/CNV_center_5_5-3-LU/record_CNV_center_5_5-3-LU.txt') as f:
    ...
    for data_seed in range(0, 5):
        r = './results/CNV_center_5_5-3-LU/' + str(a[data_seed]) + '/384_' + str(data_seed) + '/transient/best.ckpt'
